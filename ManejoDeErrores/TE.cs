   ...
   public class TE
    {
      ...
      public void reinicialista()
      {
       ...
       public void inicialestaE(){
           ...
           TErrores.Add(te10);
            Tabla_Errores te12 = new Tabla_Errores(12, "declaracion erronea", "se espera una variable luego de la declaracion, verifique ", "Se produce cuando la sintaxis de la sentencia contiene algun error");
            TErrores.Add(te12);
